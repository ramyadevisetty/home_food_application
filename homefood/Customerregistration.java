...
public class Customerregistration extends AppCompatActivity {
    ...
    TextInputLayout Fname,Lname,Email,Pass,cpass,residence,area,pincode;
    Button signup;
    FirebaseAuth FAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cpass = (TextInputLayout)findViewById(R.id.confirm_password);
        residence = (TextInputLayout)findViewById(R.id.Residence);
        pincode = (TextInputLayout)findViewById(R.id.Pin);
        area = (TextInputLayout)findViewById(R.id.Residence_area);

        signup = (Button)findViewById(R.id.customer_Register);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                house = residence.getEditText().getText().toString().trim();
                ...
                PendingIntent pendingIntent = PendingIntent.getActivity(Customerregistration.this, 0, intent, 0);
    ...
    public boolean isValid(){
        ...
        area.setError("");
        residence.setErrorEnabled(false);
        residence.setError("");
        ...
        if(TextUtils.isEmpty(house)){
           residence.setErrorEnabled(true);
           residence.setError("Fields Can't Be Empty");
        }else{
            isValidhouseno = true;
        }
