...
public class Chef_home extends Fragment{
    ...
    private void chefDishes() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("FoodDetails").child(Pin).child(Area).child(House).child(useridd);
